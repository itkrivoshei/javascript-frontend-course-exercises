...
describe("forms-fetch-api-part-2/range-picker", () => {
  ...
  it("should initially show only input", () => {
    const selector = rangePicker.element.querySelector(
  ...
  it("should highlight selected 'from' and 'to' dates in calendar", () => {
    ...
    const from = rangePicker.element.querySelector(
  ...
  it("should highlight selected dates range in calendar", () => {
    ...
    const selectedBetween = rangePicker.element.querySelectorAll(
  ...
  it("should show correct initial months in calendar", () => {
    ...
    const [first, second] = rangePicker.element.querySelectorAll(
  ...
  it("should have ability to select all dates in two visible months", () => {
    ...
    const [firstCalendar, secondCalendar] = selector.querySelectorAll(
      ".rangepicker__calendar",
    );
    const firstDateGrid = firstCalendar.querySelector(
      ".rangepicker__date-grid",
    );
    const secondDateGrid = secondCalendar.querySelector(
      ".rangepicker__date-grid",
    );
  ...
  it("should have ability to select dates range bigger than two months", () => {
    ...
    const [_, secondCalendar] = selector.querySelectorAll(
      ".rangepicker__calendar",
    );
    const secondDateGrid = secondCalendar.querySelector(
      ".rangepicker__date-grid",
